  ...
  return (
    <>
      <div className="flex flex-col min-h-screen">
        <div className="px-4 my-6 flex-grow">
                      ...
                      <tr>
                        <td colSpan="5" className="p-0">
                          <table className="w-full bg-gray-100">
                            <thead>
                              <tr>
                                <th className='font-normal bg-slate-200'>Avg Current</th>
                                <th className='font-normal bg-slate-200'>Avg Temp Panel</th>
                            ...
                            <tbody>
                              <tr className="border-b">
                                <td className='text-center text-sm'>{item.avg_current?.toFixed(2)} A</td>
                                <td className='text-center text-sm'>{item.avg_temperatureCpanel?.toFixed(2)}°C</td>
